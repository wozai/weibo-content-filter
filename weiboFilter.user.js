...
var $page = (function () {
	...
	var modules = {
			...
			MyRelation : '#pl_profile_moduleMyRelation, #Pl_Core_RightUserGrid__7',
			Relation : '#pl_profile_moduleHisRelation, #Pl_Core_RightUserGrid__7',
			Album : '#pl_profile_modulealbum, #Pl_Core_RightPicMulti__8',
